...
const Ticket = ({ price, carrier, segments }) => {
  ...
  const toStopsCount = segments[0].stops.length + 1;
  const fromStopsCount = segments[1].stops.length + 1;
  ...
  function getArrivalTime(date, duration) {
    ...
    return arrival[1] + "hr - " + arrival[2] + "min";
  }
